...
public class AutenticacaoService {
    ...
    private static final String JWT_KEY = "signingKey";
    private static final String AUTHORITIES = "authorities";
    private static final Integer EXPIRATION_TOKEN_ONE_HOUR = 3600000;

    static public void addJWTToken(HttpServletResponse response, Authentication authResult) {
